...
Function::type_property = (prop, init) ->
	Object.defineProperty @prototype, prop,
		get : -> 
			if _.isUndefined @Type.props[prop]
				@Type.props[prop] = init
			return @Type.props[prop]
...
class @Game
	...
	logger: (setLogger)->
		@_logger = setLogger or @_logger or {
...
@GameEvent.dispatcher = (type,init,callback)->
	return -> 
		evnt = new me.GameEvent type, callback
		init.apply(evnt, arguments)
		evnt.post(arguments[0])
		return evnt
